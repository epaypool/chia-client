...
import { RewardTargetResponse, SignagePointResponse, SignagePointsResponse } from './types/Farmer/RpcResponse';
import { RpcResponse } from './types/RpcResponse';
import { FarmingInfo, Message, SERVICE } from './ws';
...
class Farmer extends RpcClient {
  ...
  public onNewFarmingInfo(cb: (data: FarmingInfo) => void): void {
